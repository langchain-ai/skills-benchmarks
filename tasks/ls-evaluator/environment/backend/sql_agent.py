"""
SQL query agent with ReAct-style tool loop.
Test adding LangSmith tracing to this app.

This agent uses OpenAI function calling to decide which tools to call,
creating variable trajectories based on the question.
"""
