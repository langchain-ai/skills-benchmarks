#!/usr/bin/env python3
"""Output capture, parsing, and human-readable test reports."""
...
# =============================================================================
# OUTPUT CAPTURE & PARSING (merged from capture.py)
# =============================================================================
...
def did_invoke_skill(events: Dict, skill_name: str) -> bool:
    return skill_name in events.get("skills_invoked", [])
