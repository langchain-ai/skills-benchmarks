...
<oneliner>
How chat models call tools - includes bind_tools/bindTools, tool choice strategies, parallel tool calling, and tool message handling.
</oneliner>
...
<fix-async-tool-execution-not-awaited>
<typescript>
