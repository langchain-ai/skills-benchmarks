"""Shared fixtures and test data for LangSmith script tests.

This module contains:
- Script running utilities (run_python_script, run_ts_script)
- Script path constants (PY_QUERY_TRACES, TS_QUERY_TRACES, etc.)
- pytest fixtures for script paths
...
# =============================================================================
# MOCK OBJECT FACTORIES - Pre-built mock objects for common test scenarios
# =============================================================================
